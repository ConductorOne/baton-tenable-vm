...
- The optional `base-url` flag selects the Tenable API environment. It defaults to `https://cloud.tenable.com`; FedRAMP Moderate customers should use `https://fedcloud.tenable.com`.
