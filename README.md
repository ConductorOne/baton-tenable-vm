...
```
docker run --rm -v $(pwd):/out -e BATON_ACCESS_KEY=accessKey -e BATON_SECRET_KEY=secretKey public.ecr.aws/conductorone/baton-tenable-vm:latest -f "/out/sync.c1z"
...
Flags:
      ...
      --base-url string              Tenable Vulnerability Management API base URL. Defaults to the commercial cloud; use https://fedcloud.tenable.com for FedRAMP Moderate. ($BATON_BASE_URL) (default "https://cloud.tenable.com")
